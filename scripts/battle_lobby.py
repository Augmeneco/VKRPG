...
vkrpg.contexts.create_context('battle_lobby')
vkrpg.events.add_event('on_message', on_message, 'battle_lobby')
vkrpg.events.add_event('on_enablecontext', on_enablecontext, 'battle_lobby')
vkrpg.events.add_event('on_evloopiter', lobbyserver)
vkrpg.contexts.get_context('battle_lobby')['vars']['enemy1'] = 0
vkrpg.contexts.get_context('battle_lobby')['vars']['enemy2'] = 0